...
* Site navigation should be enhanced by the use of a dynamic navigation bar positioned on each page below the company name. Text links towards the bottom of each page.
...
* Every page should be linked to a single external stylesheet - which contains formatting instructions for headings, paragraphs and links used throughout the site.
...
- Music should not link to a specific page - but, when the user passes a mouse pointer over the button, a drop-down menu should app-ear with links to the following pages. types of music pages. 

On Selection of type the music of that type is listed
